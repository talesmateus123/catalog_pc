...
public class DBService {
	...
	public void instantiateTestDatabase() {
		...
		// Monitors creation
		Monitor monitor1 = new Monitor(null, "00012", new Date(), new Date(), null, null, null, null, sector2, null);
		Monitor monitor2 = new Monitor(null, "02013", new Date(), new Date(), null, null, null, null, sector6, null);
		
		// Computers creation
				
		Computer computer1 = new Computer(null, "02832", new Date(), new Date(), null, "Fabricante", "Modelo", 
				"Descrição", null, "ip", "mac", "hostName", "motherBoardName", null, true, "cabinetModel", 
				OperatingSystem.WINDOWS_7,	ArchitectureType.AMD64, ComputerType.DESKTOP, true, false, "", "", 
				0.0, 0.0, monitor1);
		
		Computer computer2 = new Computer(null, "34681", new Date(), new Date(), null, "Fabricante", "Modelo", 
				"Descrição", null, "ip", "mac", "hostName", "motherBoardName", null, true, "cabinetModel", 
				OperatingSystem.WINDOWS_7,	ArchitectureType.AMD64, ComputerType.DESKTOP, true, false, "", "", 
				0.0, 0.0, monitor1);
		...
		// Processors creation
		Processor processor1 = new Processor(null, new Date(), new Date(), null, "Intel", "model", "description", 
				"i7 7000U ", ArchitectureType.AMD64, computer1);
		Processor processor2 = new Processor(null, new Date(), new Date(), null, "Intel", "model", "description", 
				"i7 7000U ", ArchitectureType.AMD64, computer2);
				
		// Ram memories creation
		RamMemory ramMemory1 = new RamMemory(null, new Date(), new Date(), null, null, null, null, 1.0, RamMemoryArchitecture.DDR3, computer1);
		RamMemory ramMemory2 = new RamMemory(null, new Date(), new Date(), null, null, null, null, 2.0, RamMemoryArchitecture.DDR3, computer1);
		RamMemory ramMemory3 = new RamMemory(null, new Date(), new Date(), null, null, null, null, 0.5, RamMemoryArchitecture.DDR2, computer2);
		RamMemory ramMemory4 = new RamMemory(null, new Date(), new Date(), null, null, null, null, 1.0, RamMemoryArchitecture.DDR3, computer2);
		
		// Storage devices creation
		StorageDevice storageDevice1 = new StorageDevice(null, new Date(), new Date(), null, null, null, null, 1000.0, StorageDeviceArchitecture.SATA, StorageDeviceType.HD, computer1);
		StorageDevice storageDevice2 = new StorageDevice(null, new Date(), new Date(), null, null, null, null, 1000.0, StorageDeviceArchitecture.SATA, StorageDeviceType.HD, computer1);
		StorageDevice storageDevice3 = new StorageDevice(null, new Date(), new Date(), null, null, null, null, 2000.0, StorageDeviceArchitecture.SATA, StorageDeviceType.HD, computer2);
		StorageDevice storageDevice4 = new StorageDevice(null, new Date(), new Date(), null, null, null, null, 500.0, StorageDeviceArchitecture.SATA, StorageDeviceType.HD, computer2);
		...
		// Printers creation
		Printer printer1 = new Printer(null, "PML0000", new Date(), new Date(), null, "manufacturer", "model", 
				"description", sector1, "ipAddress", "macAddres", "hostName");
