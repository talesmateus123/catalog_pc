...
public class AddressService {
	...
	public Address findBySector(Sector sector) {
		Optional<Address> object = this.repository.findBySector(sector);
		return object.orElseThrow(()-> new ObjectNotFoundException("This Sector: '" + sector.getName() + "' doesn't exists. Type: " + object.getClass().getName()));
	}
